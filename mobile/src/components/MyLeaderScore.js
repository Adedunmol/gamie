...
const MyLeaderScore = ({ text, name, xp }) => {
    return (
        <LinearGradient
            colors={["#8E51AD", "#5C2FBA"]}
            style={{ padding: 10, gap: 10, alignItems: "center", borderRadius: 6, flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}
        >
